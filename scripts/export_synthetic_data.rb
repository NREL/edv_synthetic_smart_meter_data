...
begin
  ...
  for i in 1..column_headers.count-1
    ...
    out_path = File.expand_path("../#{WORKFLOW_OUTPUT_DIR}/#{SIM_FILES_DIR}/#{File.basename(building_sync_file_path, File.extname(building_sync_file_path))}/", File.dirname(__FILE__))
